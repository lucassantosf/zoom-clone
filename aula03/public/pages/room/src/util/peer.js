class PeerBuilder{
  constructor({peerConfig}){
    ...
    this.onPeerStreamReceveid = defaultFunctionValue
  ...
  setOnPeerStreamReceveid(fn){
    this.onPeerStreamReceveid = fn
    return this
  }

  _prepareCallEvent(call){
    call.on('stream',stream => this.onPeerStreamReceveid(call,stream))
