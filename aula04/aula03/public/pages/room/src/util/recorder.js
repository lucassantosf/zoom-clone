class Recorder{
  ...
  startRecording(){
    ...
    //senao estiver recebendo mais video, ignora
    if(!this.stream.active) return;

    this.mediaRecorder = new MediaRecorder(this.stream,options)
    console.log(`Created MediaRecorder ${this.mediaRecorder} with option ${options} `)
